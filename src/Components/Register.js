...
import img1 from '../assets/register-form.webp'
          ...
          <div className='col-lg-6 register-col'>
            ...
            <div className='form'>
              ...
              <input
                type='submit'
                value='REGISTER-NOW'
                className='btn-submit register-submit'
                style={{ border: 'none', borderRadius: '5px', height: '50px' }}
              ></input>
              <p className='color register-p-notice'>
